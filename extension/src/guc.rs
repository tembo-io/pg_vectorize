...
pub static OLLAMA_URL: GucSetting<Option<&CStr>> = GucSetting::<Option<&CStr>>::new(None);
...
pub fn init_guc() {
    ...
    GucRegistry::define_string_guc(
        ...
        "Ollama Host address",
        "Address of host where Ollama is running. Default Value is http://0.0.0.0:11434",
        &OLLAMA_URL,
        GucContext::Suset,
        GucFlags::default(),
    );
